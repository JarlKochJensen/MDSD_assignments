...
public class MathGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class PrimaryElements extends AbstractParserRuleElementFinder {
		...
		private final Action cParenthesisAction_1 = (Action)cAlternatives.eContents().get(1);
		...
		//    {MathNumber} value=INT | {Parenthesis} | '(' exp=Exp ')' |  VariableUse | LetBinding
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//{Parenthesis}
		public Action getParenthesisAction_1() { return cParenthesisAction_1; }
